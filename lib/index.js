...
internals.with = function () {
    ...
    internals.assert(this, typeof this._ref === 'function', 'Can only call with on a function');

    this._ref = () => fun.apply(this, arguments);
    return this;
};

internals.addMethod(['with', 'withArgs', 'withArguments'], internals.with);

internals.on = function (target) {

    const fun = this._ref;
    internals.assert(this, typeof this._ref === 'function', 'Can only call on on a function');
    internals.assert(this, target instanceof Object, 'Can only call on with a function');

    this._ref = fun.bind(target);
    return this;
};

internals.addMethod(['on', 'withThis'], internals.on);

internals.result = function () {
...
internals.addMethod(['result'], internals.result);
