...
internals.calledWith = function () {

    const fun = this._ref;

    internals.assert(this, typeof this._ref === 'function', 'Can only calledWith on a function');

    this._ref = () => fun.apply(this, arguments);
    return this;
};

internals.addMethod(['calledWith'], internals.calledWith);
