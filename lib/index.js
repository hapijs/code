...
exports.addCustomMatcher = function (names, updateInternals) {

    internals.addMethod(names, function () {

        return updateInternals.apply(null, [this, this._ref].concat([].slice.call(arguments)));
    });
};
